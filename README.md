...
저 역시 **AWS**는 범용 애플리케이션·인프라(컴퓨트, API, 저장소 등) 목적으로, **GCP**는 분석·ML·AI 관련 목적으로 주로 사용해 왔습니다. 이번 과제는 HTTP API·NoSQL·실시간 알림이 묶인 **업무용 웹 대시보드**에 가깝기 때문에, **AWS**에서 아래 서비스를 조합해 구현했습니다.
